...
window.SITE = {
  ...
  templates: [
    { name: "Shubh Vivah — Royal", tagline: "With Love Story", cat: "Wedding", tier: "Luxury", tag: "Bestseller", style: "royal",
      desc: "Ornate maroon & teal with mandala, marigold toran, diyas, scratch-reveal date, love story, timeline, blessings & RSVP.",
      file: "../indian-wedding-with-story.html", img: "img/w4.jpg", palette: ["#6a0f1c","#0e5a5e","#c9a24b"] },
    { name: "Emerald Heritage", tagline: "Green · Wine · Gold", cat: "Wedding", tier: "Luxury", tag: "Premium", style: "modern",
      desc: "Deep emerald with wine & gold and a refined Marcellus typeface. Timeless, understated, heritage-royal luxury.",
      file: "../royal-emerald.html", img: "img/w2.jpg", palette: ["#0f5132","#7a1f3a","#c9a24b"] },
    { name: "Peacock Royal", tagline: "Blue · Teal · Gold", cat: "Wedding", tier: "Premium", tag: "New", style: "arch",
      desc: "Regal peacock-blue with a Playfair display face and arched portraits. Bold, contemporary and grand.",
      file: "../royal-peacock.html", img: "img/w3.jpg", palette: ["#123c72","#0e5a5e","#c9a24b"] },
    { name: "Rani Pink Royal", tagline: "Magenta · Purple · Gold", cat: "Wedding", tier: "Premium", tag: "Trending", style: "floral",
      ...
      file: "../royal-rani-pink.html", img: "img/w7.jpg", palette: ["#a3164f","#5a2b6e","#c9a24b"] },
    { name: "Shubh Vivah — Traditional", tagline: "Without Love Story", cat: "Wedding", tier: "Premium", tag: "For families", style: "royal",
      desc: "Royal design, family-first. No romance sections — leads with blessings. Ideal for traditional families.",
      file: "../indian-wedding-no-story.html", img: "img/w8.jpg", palette: ["#0e5a5e","#6a0f1c","#c9a24b"] },
    { name: "Ivory Minimal", tagline: "Modern Minimal", cat: "Wedding", tier: "Basic", tag: "", style: "modern",
      ...
      file: "../demo.html", img: "img/hero.jpg", palette: ["#b08d4f","#9a7b3f","#d8be86"] },
  ],
  ...
  pricing: [
    { name: "Basic", price: "1,499", popular: false, perks: ["A complete single-event invite", "Save the Date / Engagement", "Live RSVP collection", "Mobile-first design", "Scratch reveal + countdown", "WhatsApp & QR ready"] },
    { name: "Premium", price: "2,999", popular: true, perks: ["Up to 4 functions", "Full gallery + live countdown", "Family blessings section", "Background music", "Digital shagun (UPI)", "Delivered in 24–48 hours"] },
    { name: "Luxury", price: "4,999", popular: false, perks: ["Everything in Premium", "Full 6+ function suite", "Love story + timeline", "Custom colours & fonts", "Personalised guest links", "Priority designer + support"] },
  ],
